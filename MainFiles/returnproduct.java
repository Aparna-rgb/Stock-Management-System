...
String pri = jTextField4.getText();
try {
    double N3 = Double.parseDouble(pri); // Use Double.parseDouble instead of Integer.parseInt
    double N1 = Double.parseDouble(qun); // Use Double.parseDouble instead of Integer.parseInt
    double N4 = N1 * N3;
    jTextField5.setText(String.valueOf(N4)); // Store as string
